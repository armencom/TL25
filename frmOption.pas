...
function TfrmOptionDlg.TableRowCount(tbl: string): integer;
begin
...
procedure TfrmOptionDlg.btnRestoreDefaultsClick(Sender: TObject);
var
  tab: integer;
begin
...
procedure TfrmOptionDlg.Button1Click(Sender: TObject);
var
...
procedure TfrmOptionDlg.btnAddClick(Sender: TObject);
var
  grid: TcxGrid;
  view: TcxGridDBTableView;
  Arr: TArray<string>;
...
procedure TfrmOptionDlg.CreateConfig(sTableName: string);
begin
  qry.Close;
  qcnt.SQL.Clear;
  qcnt.SQL.Text :=
...
procedure TfrmOptionDlg.CreateConfigBBIO;
begin
  qry.Close;
  qcnt.SQL.Clear;
  qcnt.SQL.Text :=
...
procedure TfrmOptionDlg.FormActivate(Sender: TObject);
const
...
procedure TfrmOptionDlg.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  action := caFree;
end;

procedure TfrmOptionDlg.qryAfterPost(DataSet: TDataSet);
var i: integer;
begin
  UpdateSymbolCount;
end;

procedure TfrmOptionDlg.qryBeforePost(DataSet: TDataSet);
var
  tab : integer;
  Value: string;
begin
...
procedure TfrmOptionDlg.SetupScript(tbl: integer);
begin
  case tbl of
    _TAB_BBIO: begin
      DM.CreateConfigBBIO;
...
procedure TfrmOptionDlg.tabPagesChange(Sender: TObject);
var
  tab : integer;
begin
  qry.Active := false;
...
procedure TfrmOptionDlg.UpdateSymbolCount;
var
  tab: integer;
begin
  tab := tabPages.TabIndex;
...
function TfrmOptionDlg.TableExists(AConnection: TFDConnection; const ATableName: string): Boolean;
var
  List: TStringList;
begin
  Result := False;
...
procedure TfrmOptionDlg.InsertIntoConfigBBIO;
var
  i: integer;
  Q: TFDQuery;
begin
...
procedure TfrmOptionDlg.InsertIntoConfigETF;
var
  Q: TFDQuery;
begin
...
procedure TfrmOptionDlg.InsertIntoConfigFutures;
var
  Q: TFDQuery;
begin
...
procedure TfrmOptionDlg.InsertIntoConfigMUTS;
var
  Q: TFDQuery;
  i, BatchSize: Integer;
begin
...
procedure TfrmOptionDlg.InsertIntoConfigStrategy;
var
  Q: TFDQuery;
begin
...
class function TfrmOptionDlg.Execute: TModalResult;
var
  sErrLocus : string;
begin
...
function TfrmOptionDlg.getCurrentTableAndView: TArray<string>;
var
  tab : integer;
begin
  tab := tabPages.TabIndex;
